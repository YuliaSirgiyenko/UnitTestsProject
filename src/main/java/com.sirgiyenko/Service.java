 ...
 * For storing data service has to call {@link Dao#store(Entity)} method
 * For retrieving stored data service has to call {@link Dao#findAll()} method
 */
public interface Service {
	 ...
	 * @param price the price of an item, in case of scale more than 3 should be rounded 2 decimal points
